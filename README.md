...
- [database_schema.sql](database_schema.sql)      # MySQL database setup
- [data_fetcher.py](data_fetcher.ipynb)          # API data fetching script
- [portfolio_analyzer.py](portfolio_analyzer.ipynb)    # Analysis and visualization
- [requirements_analyst.txt](requirements_analyst.txt) # Python dependencies
